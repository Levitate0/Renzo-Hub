...
fun AccountScreen(
    ...
    val store = (context.applicationContext as RenzoApp).offlineStore
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Row(verticalAlignment = Alignment.CenterVertically) {
                                    RenzoButton(
                                        ...
                                        variant = "outline",
                                        small = true,
                                        onClick = { HubForeground.leavingApp(); avatarPicker.launch(ALLOWED_AVATAR_TYPES.toTypedArray()) },
                                    )
                    ...
                    SettingsCard(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.fillMaxWidth()) {
                            ...
                            RenzoButton(
                                ...
                                variant = "outline",
                                small = true,
                                onClick = { HubForeground.leavingApp(); folderPicker.launch(null) },
                            )
                        }
                        CardDivider()
                        RenzoButton(
